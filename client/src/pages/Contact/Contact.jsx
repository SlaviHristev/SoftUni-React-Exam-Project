...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
            .sendForm('service_9bhicrs', 'template_rwejh1w', formRef.current, {
                publicKey: 'nt4mxQ5ZpzzCtJ9XP',
            })
            .then(
                (result) => {
                    setSuccess(true)
        ...
        <motion.div className='contact' variants={variants} initial='initial' whileInView='animate' ref={ref}>
            <motion.div className="textContainer" variants={variants}>
                ...
                <motion.div className="item" variants={variants}>
                    <h2>Mail</h2>
                    <span>Slavihristev97@gmail.com</span>
                </motion.div>
                <motion.div className="item" variants={variants}>
                    <h2>Adress</h2>
                    <span>Pazardzhik, Bulgaria</span>
                </motion.div>
                <motion.div className="item" variants={variants}>
                    <h2>Phone</h2>
                    <span>+359889928050</span>
                </motion.div>
            </motion.div>
